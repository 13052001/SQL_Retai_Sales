...
-- How many numbers of sales it has?
...
--Questions
-- Q.1 query to retrieve all columns for sales made on '2022-11-05
-- Q.2 query to retrieve all transactions where the category is 'Clothing' and the quantity sold is more than 10 in the month of Nov-2022
-- Q.3 query to calculate the total sales (total_sale) for each category.
-- Q.4 query to find the average age of customers who purchased items from the 'Beauty' category.
-- Q.5 query to find all transactions where the total_sale is greater than 1000.
-- Q.6 query to find the total number of transactions (transaction_id) made by each gender in each category.
-- Q.7 query to calculate the average sale for each month. Find out best selling month in each year
-- Q.8 query to find the top 5 customers based on the highest total sales 
-- Q.9 query to find the number of unique customers who purchased items from each category.
